    ...
    public function update(UpdateOfferRequest $request, $id)
    {
        ...
        return DB::transaction(function () use ($request, $id, $user) {
            ...
            $offer->update([
                ...
                'vat_percent' => $request->vat_percent ?? $offer->vat_percent,
                'pph_percent' => $request->pph_percent ?? $offer->pph_percent,
                'ppn_amount' => $request->ppn_amount ?? $offer->ppn_amount,
                'pph_amount' => $request->pph_amount ?? $offer->pph_amount,
                'is_dp' => $request->boolean('is_dp'),
